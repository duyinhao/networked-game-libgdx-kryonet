...
public class HeroEquip {
	...
	/*
	static Texture foreArmSprite  = new Texture(Gdx.files.internal("foreArm.png") );
	static Texture armSprite= new Texture(Gdx.files.internal("heroTrunk.png") );
	static Texture bodySprite= new Texture(Gdx.files.internal("heroTrunk.png") );
	static Texture legSprite= new Texture(Gdx.files.internal("heroLeg1.png") );
	static Texture bootSprite= new Texture(Gdx.files.internal("heroTrunk.png") );
	static Texture headSprite= new Texture(Gdx.files.internal("heroHead1.png") );
        */
        
        
	static Texture heroHead1= new Texture(Gdx.files.internal("heroHead1.png"));
	static Texture heroHead2= new Texture(Gdx.files.internal("heroHead2.png")); 
	static Texture heroTrunk= new Texture(Gdx.files.internal("heroTrunk.png"));
	static Texture heroBody= new Texture(Gdx.files.internal("heroBody.png"));
